        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_MenuCategories_MenuCategories_SubCategory",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_MenuItemMealTimes", x => new { x.MenuItemId, x.MealTimeId });
                    table.ForeignKey(
                        name: "FK_MenuItemMealTimes_MealTimes_MealTimeId",
                        column: x => x.MealTimeId,
                        principalTable: "MealTimes",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_MenuItemMealTimes_MenuItems_MenuItemId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    Ammount = table.Column<decimal>(type: "decimal(18,2)", nullable: false, defaultValue: 0m),
                    MenuItemId = table.Column<int>(type: "int", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "datetime2", nullable: false)
                },
            ...
            migrationBuilder.CreateIndex(
                name: "IX_MenuCategories_SubCategory",
                table: "MenuCategories",
                column: "SubCategory");

            migrationBuilder.CreateIndex(
                name: "IX_MenuItemMealTimes_MealTimeId",
                table: "MenuItemMealTimes",
                column: "MealTimeId");
